...
combine -M HybridNew -v -1 --LHCmode LHC-limits --saveToys --saveHybridResult -m ${1} --setParameters MA=${2} --freezeParameters=MA -T 200 ${3} -n ${4} --expectedFromGrid 0.5 --clsAcc 1
mkdir H${1}
mv ${5}.123456.quant0.500.root H${1}
