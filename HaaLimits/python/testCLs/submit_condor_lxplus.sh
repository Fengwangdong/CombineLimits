...
then
    ...
    do
	    ...
	    condor_submit condor_025.sub 
        condor_submit condor_16.sub
        condor_submit condor_84.sub
        condor_submit condor_975.sub
        condor_submit condor_med.sub
        condor_submit condor_obs.sub
	done
fi
